...
import { MakeTransactionDTO } from 'account/application/dtos/make-transaction-dto.ts';
...
export class TransferUseCase {
  ...
  async execute(input: MakeTransactionDTO) {
    ...
    const repositoryTasks = [
      ...
      this.updateAccountRepository.update(senderAccount),
      this.updateAccountRepository.update(receiverAccount),
    ];
